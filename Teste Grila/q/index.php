            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-5-answers-A">A) Wikipedia</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
                        <label for="question-5-answers-B">B) E3School</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                        <label for="question-5-answers-C">C) Youtube</label>
                    </div>
...
<br>
<FORM><INPUT Type="button" VALUE="Inapoi la pagina anterioara" onClick="history.go(-1);return true;"></FORM>
<br>
</body>
